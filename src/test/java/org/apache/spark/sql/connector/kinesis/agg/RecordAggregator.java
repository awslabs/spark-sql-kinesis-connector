 ...
 */
package org.apache.spark.sql.connector.kinesis.agg;
...
public class RecordAggregator {
   ...
   *
   * @param userRecord The Kinesis user record to add to this aggregated record
  ...
  public AggRecord addUserRecord(KinesisClientRecord userRecord) throws Exception {
    ...
    return addUserRecord(userRecord.partitionKey(), userRecord.explicitHashKey(), userRecord.data().array());
  }
